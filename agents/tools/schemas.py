...
class ToolSchemas:
    ...
    def __init__(self, mcp_tool_schemas: list[dict] | None = None, memory_tool_schemas: list[dict] | None = None):
        self.mcp_tools = mcp_tool_schemas or []
        self.memory_tools = memory_tool_schemas or []

        self.explore_subagent_tools = [_TOOL_DEFS[k] for k in _EXPLORE_SUBAGENT_TOOLS] + self.mcp_tools + self.memory_tools
        self.general_subagent_tools = [_TOOL_DEFS[k] for k in _GENERAL_SUBAGENT_TOOLS] + self.mcp_tools + self.memory_tools
        self.teammate_tools = [_TOOL_DEFS[k] for k in _TEAMMATE_TOOLS] + self.mcp_tools + self.memory_tools
        self.main_agent_tools = [_TOOL_DEFS[k] for k in _MAIN_AGENT_TOOLS] + self.mcp_tools + self.memory_tools
